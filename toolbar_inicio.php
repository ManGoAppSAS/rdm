...
<head>
	...
	<title>Reglas de diseño ManGo! - Toolbar Inicio</title>
...
<header class="rdm-toolbar--contenedor">	
	<div class="rdm-toolbar--fila">
		<div class="rdm-toolbar--izquierda">
			<a href="index.php"><div class="rdm-toolbar--icono"><i class="zmdi zmdi-power zmdi-hc-2x"></i></div></a>
		</div>
		<div class="rdm-toolbar--centro">
			<h2 class="rdm-toolbar--titulo-centro"><span class="logo_img"></span> ManGo!</h2>
		</div>
		<div class="rdm-toolbar--derecha">
			<a href="index.php"><div class="rdm-toolbar--icono"><i class="zmdi zmdi-settings zmdi-hc-2x"></i></div></a>
		</div>
	</div>
</header>
